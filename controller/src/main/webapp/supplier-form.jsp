...
<c:choose>
    <c:when test="${param.action==\"add\"}">
        ...
        <div class="container">
            <form name="add" method="post" action="supplier">
    ...
    <c:when test="${param.action==\"edit\"}">
        <h2>Редактирование данных о поставщике</h2>

        <div class="container">
            <form name="edit" method="post" action="supplier">
    ...
    <c:when test="${param.action==\"delete\"}">
        <h2>Удаление данных о поставщике</h2>

        <div class="container">
            <form name="delete" method="post" action="supplier">
                <input name="idSupplier" type="hidden" value="${param.idSupplier}">
